...
session_start();
?>
<form name="form2" action="dashboard_confirm_action" method="POST" enctype="multipart/form-data">
...
<br>
 ...
 <form action="dashboard_confirm_action.php" method="post" enctype="multipart/form-data" >
